...
<body>
    ...
    <div class="container px-5 my-5">
        <form method="POST" action="/providers/addProvider">
            <div class="form-floating mb-3">
                <input class="form-control" name="nameProvider" id="nombre" type="text" placeholder="Nombre" data-sb-validations="required" />
            ...
            <div class="form-floating mb-3">
                <input class="form-control" name="products" id="product" type="text" placeholder="Producto" data-sb-validations="" />
